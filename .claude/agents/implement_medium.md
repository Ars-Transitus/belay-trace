---
name: implement_medium
description: Medium-difficulty implementation worker for non-trivial multi-file or integration changes. Spawn only from an approved Delivery Map task. Do not use for design or orchestration.
